    ...
    Vue.mixin({
      ...
      head () {
        ...
        if (
          ...
          headDescription.style.push(getStyleDescription(prepareRatioStyle((this.$root._pagePayload || global.__NUXT__).fetch), false,
          // TODO: Name!
            'image-picture-ratios-' + this.$parent.routerViewKey));
        }
